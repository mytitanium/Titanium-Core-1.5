/* src/config/ttm-config.h.  Generated from ttm-config.h.in by configure.  */
/* src/config/ttm-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Ttm Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Ttm Core"
...
#define PACKAGE_BUGREPORT "https://github.com/mytitanium/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Ttm Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Ttm Core 1.5.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ttmcore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://titanium-blocks.org/"
